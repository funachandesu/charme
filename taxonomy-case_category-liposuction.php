...
<div id="main">
    ...
    <div class="case-banner"><img src="https://charme-beauty.jp/wp-content/uploads/banner-liposuction.png" alt="" /></div>

    <div class="case-des">
        <div class="container">					ダイエットしてもなかなか痩せない部分があります。理想的なボディバランスを手に入れるための効果的な施術になります。<br>
					体の一部だけ痩せたい、短期間で痩せたい、自力で痩せられないetc...。お客様のニーズに沿った施術をご案内させて頂きます。
        </div>
    </div>
            ...
            <ul>
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=kusanotaro&s=&post_type=case">
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=sherieclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=primo&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=athena&s=&post_type=case">
                            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=womclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=veary&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=veary&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=komuroclinic&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=komuroclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=dazzyclinic&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=liposuction&case_clinic=dazzyclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                            </a>
                    </div>
                </li>
