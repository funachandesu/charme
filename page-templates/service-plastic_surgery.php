...
<?php
			...
			$args = array(
				'clinics' => [
                    ...
                    [
						'id' => 238,
						'en-title' => 'Primo Azabujuban clinic',
						'jp-title' => 'プリモ麻布十番クリニック',
						'img-full' => 'primo_img_09.jpg',
						'logo' => 'logo_primo.jpg',
						'address' => '〒106-0045　東京都港区麻布十番1-10-10 ジュールA 地下1階',
						'tel' => '0120-062-069',
                    ...
                    [
						'id' => 210,
						'en-title' => 'Filler clinic',
						'jp-title' => 'フィラークリニック',
						'img-full' => 'about_img.jpg',
						'logo' => 'logo_efiller.png',
						'address' => '〒160-0022 東京都新宿区新宿3丁目19-4 MLJ新宿7階',
						'tel' => '03-3226-5125',
						'website' => 'https://www.efiller.jp/',
						'tag' 	=> '注入治療,美肌治療'
					],
                    [
						'id' => 231,
					...
					[
						'id' => 222,
						'en-title' => 'Komuro clinic',
						'jp-title' => 'コムロクリニック',
						'img-full' => 'komuro_2.jpg',
						'logo' => 'logo_komuroclinic.png',
						'address' => '〒104-0061
                        東京都中央区銀座1-6-8 DEARGINZA8階',
						'tel' => '0120-566-315',
						'website' => 'https://komuroclinic.jp/',
						'tag' 	=> '二重・目元,鼻,バスト,脂肪吸引,輪郭'
					],
					// [
					// 	'id' => 228,
			...
			?>
	<div class="top">
		<!-- <section id="service-content-plastic-surgery" class="top-section">
			<div class="container">
				<div class="sec-title">
					<h2 class="title-en">SERVICE</h2>
					<h3 class="title-ja">美容整形</h3>
				</div>
			</div>
		</section> -->
        <section id="service-content-plastic-surgery" class="top-section">
    ...
    <div class="animate" data-aos="fade-up"
          data-aos-anchor-placement="top-bottom">
            ...
            <div class="sec-title scroani">
              <h2 class="title-en title-case">SERVICE&nbsp;<span class="title-ja">-美容整形-</span></h2>
