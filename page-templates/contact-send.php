...
<!-- <section id="case-content" class="top-section">
    ...
    <div class="back">
        <div class="container">
            <a href="<?php echo esc_url(get_permalink(2)); ?>">
...
<?php
	switch($mode) {
		case 'error':
			include_once(get_template_directory().'/include/contact/error.php');
		break;
		case 'confirm':
			include_once(get_template_directory().'/include/contact/confirm.php');
		break;
		case 'input':
		default:
			include_once(get_template_directory().'/include/contact/input.php');
		break;
	}
?>
	</div></div>
