...
<div id="main">
    ...
    <div class="case-banner"><img src="https://charme-beauty.jp/wp-content/uploads/banner-bust.png" alt="" /></div>

    <div class="case-des">
        <div class="container">						女性にとって重要な要素であるバスト。ふっくらとして美しい理想のバストを手に入れたいとバストのお悩みを抱えている女性は多くいらっしゃいます。<br>
					胸を大きくしたい、胸にハリをもたせたい、胸の形を整えたいetc...。お客様のニーズに沿った施術をご案内させて頂きます。
        </div>
    </div>
            ...
            <ul>
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=bust&case_clinic=kusanotaro&s=&post_type=case">
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=bust&case_clinic=primo&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=bust&case_clinic=womclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=bust&case_clinic=idhospital2&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=bust&case_clinic=veary&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=bust&case_clinic=veary&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=bust&case_clinic=komuroclinic&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=bust&case_clinic=komuroclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=bust&case_clinic=dazzyclinic&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=bust&case_clinic=dazzyclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                            </a>
                    </div>
                </li>
