...
<div id="main">
    ...
    <div class="case-banner"><img src="https://charme-beauty.jp/wp-content/uploads/banner-makeup.png" alt="" /></div>

    <div class="case-des">
        <div class="container">					ファッションのひとつとして人気のアートメイク。メイクが苦手でも理想の眉、アイライン、リップが手に入ります。<br>
					メイクを簡単にしたい、すっぴんでもきれいな眉毛を維持したいetc...。お客様のニーズに沿った施術をご案内させて頂きます。
        </div>
    </div>
            ...
            <ul>
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=makeup&case_clinic=kusanotaro&s=&post_type=case">
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="<?php echo esc_url(get_permalink(201)); ?>">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="<?php echo esc_url(get_permalink(238)); ?>">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=makeup&case_clinic=glowclinic&s=&post_type=case">
                            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="<?php echo esc_url(get_permalink(67)); ?>">
                            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="<?php echo esc_url(get_permalink(231)); ?>">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=makeup&case_clinic=shibuyamori&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=makeup&case_clinic=veary&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=makeup&case_clinic=veary&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=makeup&case_clinic=komuroclinic&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=makeup&case_clinic=komuroclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=makeup&case_clinic=dazzyclinic&s=&post_type=case">
                            <figure>
                                <img width="400" height="300" src="<?php echo get_template_directory_uri(); ?>/imgs/clinic/logo_dazzy.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />
                            </figure>
                        </a>
                    </div>
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=makeup&case_clinic=dazzyclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                            </a>
                    </div>
                </li>
