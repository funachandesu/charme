...
<div id="main">
    ...
    <div class="case-banner"><img src="https://charme-beauty.jp/wp-content/uploads/banner-skin.png" alt="" /></div>

    <div class="case-des">
        <div class="container">					紫外線や乾燥などの外的要因や栄養の過不足やストレスなどでしわ・たるみ・毛穴が一度悪化してしまうとご自宅のケアだけでは改善が難しいため、的確な治療が必要になります。<br>
					年々増えていくしわをなんとかしたい、白い肌を取り戻したいetc...。お客様のニーズに沿った施術をご案内させて頂きます。
        </div>
    </div>
            ...
            <ul>
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=skin&case_clinic=kusanotaro&s=&post_type=case">
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=skin&case_clinic=sherieclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=skin&case_clinic=athena&s=&post_type=case">
                            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=skin&case_clinic=womclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                ...
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=skin&case_clinic=veary&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=skin&case_clinic=veary&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=skin&case_clinic=komuroclinic&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=skin&case_clinic=komuroclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                        </a>
                    </div>
                </li>
                <li>
                    <div class="col case-left">
                        <a class="case-logo" href="https://charme-beauty.jp/?case_category=skin&case_clinic=dazzyclinic&s=&post_type=case">
                            <figure>
                    ...
                    <div class="col case-right">
                        ...
                        <div class="case-img" data-slider-3></div>
                        <div class="popup"></div>
                        <a class="readmore" href="https://charme-beauty.jp/?case_category=skin&case_clinic=dazzyclinic&s=&post_type=case">
                            <img src="<?php echo get_template_directory_uri(); ?>/imgs/common/readmore.png" alt="read more">
                            </a>
                    </div>
                </li>
